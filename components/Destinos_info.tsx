  ...
  return (
    ...
    >
      <div className="w-full bg-whites rounded-2xl shadow-2xl flex flex-col h-full">
        ...
        <div className="flex flex-col flex-grow p-6 bg-white rounded-b-2xl relative">
            ...
            <div className="flex text-[16px]">
              ...
              {Titulo === undefined ? (
                ...
                <div className="flex flex-col">
                  ...
                  <div className=" flex">
                    <Hotel />
                    <span className="text-md ml-1">{Hotels}</span>{" "}
          ...
          <h4 className="text-3xl  font-bold text-[#58167D]">
          ...
          <div className=""> {/* Eliminado h-[30%] */}</div>
